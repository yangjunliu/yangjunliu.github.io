...
features: # 可选的
  - title: 数据仓库
    details: 数仓概念，数据收集，数据清洗，OLAP数据库，SQL等相关技术
    link: /dw/ # 可选
    imgUrl: /img/web.png # 可选
  - title: 机器学习
    details: 算法，基础概念，分类和回归模型，机器学习库等相关技术
    link: /ui/
    imgUrl: /img/ui.png
  - title: 技术
...
- **Email**: <a href="mailto:233biubiu@gmail.com">894072666@qq.com</a>
- **GitHub**: <https://github.com/yangjunliu>
